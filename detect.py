...
#                     cv2.imshow('mask', img)
#                     socket2()
#label1に学習させてあるモデルのモデル名を入れることで,モデル検知をすることができる. label1=="mask"
#認識したものを別ウインドーにて可視化する為にその認識した画像を保存する.img = cv2.imread('mask.jpg')
#認識したものを可視化する.cv2.imshow('mask', img)
#==================================================================================================#
                # 結果を書く
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='mask350.pt', help='model.pt path(s)')
